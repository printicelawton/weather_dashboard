// weatherapp API Key = 4e2f0bca6c645b82db8a9da4588af870
...
$(document).ready(function() {
    ...
    $("#searchbutton").on("click", function(input){
      ...
      $.ajax({
       type: "GET",
       url: "https://api.openweathermap.org/data/2.5/weather?q=" + input + "&appid=4e2f0bca6c645b82db8a9da4588af870&units=imperial",
       dataType: "json",
       success: (function(data){
          ...
          $.ajax({
            type: "GET",
            url: "https://api.openweathermap.org/data/2.5/uvi?lat=" + latitude + "&lon=" + longitude + "&appid=4e2f0bca6c645b82db8a9da4588af870",
            dataType: "json",
            success: (function(data){
    ...
    function getFiveDay(input){
      ...
      $.ajax({
        type: "GET",
        url: "https://api.openweathermap.org/data/2.5/forecast?q=" + input + "&appid=4e2f0bca6c645b82db8a9da4588af870&units=imperial",
        dataType: "json",
        success: (function(data){
